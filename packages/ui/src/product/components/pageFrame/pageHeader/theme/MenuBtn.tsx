...
// style components
import { StyledThemeMenuButton } from "@graffitoryu/ui/product/styles/styled/components/ThemeMenu";

// state
import { themeState } from "@graffitoryu/ui/product/jotai/theme.state";

// util
import { getSystemTheme } from "@graffitoryu/ui/product/utils/interactions/theme.util";

export default function ThemeMenuBtn({ code }: { code: SystemThemeMenuType }) {
  const [theme, setTheme] = useAtom(themeState);
  const [hover, setHover] = useState("");

  const changeTheme = useCallback(
    (selectedTheme: SystemThemeMenuType) => {
