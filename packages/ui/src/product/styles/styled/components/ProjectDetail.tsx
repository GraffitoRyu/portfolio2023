...
// util
import { rem, widthRatio } from "@graffitoryu/ui/product/utils/style.util";
...
import {
  ...
  size,
  transition,
} from "@graffitoryu/ui/product/styles/styled/preset/mixins";
import { easing } from "@graffitoryu/ui/product/styles/styled/preset/easing";
...
export const StyledPDVisualTitleLine = styled.span<{ $index: number }>`
  ...
  ${font({
    ...
    spacing: 0,
    weight: 400,
    family: typography.family.serifDisplay,
  })}
...
export const StyledPDSummaryItem = styled(StyledPDInfoItem)`
  ...
  @media only screen and ${media.min.tablet} and ${media.max.desktop} {
